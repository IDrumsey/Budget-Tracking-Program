...
{
	float totalExpenses = 0, totalIncome = 0, i;
	system("cls");
	cout << "Budget Report\n";
	for (i = 0; i < listOfExpenseNodes.size(); i++)
	{
		totalExpenses += listOfExpenseNodes[i].amountOfPurchase;
	}
	for (i = 0; i < listOfIncomeNodes.size(); i++)
	{
		totalIncome += listOfIncomeNodes[i].amountRecieved;
	}
